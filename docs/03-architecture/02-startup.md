...
**결과: 10,000 요청당 총합 = 0.276 USD / 월**


### 1.3.2. 1GB당 서비스 합계
* **CloudWatch 표준 로그**: 0.76 $* **S3**: 0.07$
* **CloudFront 인터넷 전송**: 0.12 $* **CloudFront 오리진 전송**: 0.06$
* **합계**: 1.01 $

**결과: 1GB당 총합 = 1.01 USD / 월**

### 1.3.3. 나머지 서비스 합계 (고정/개당/월)
* **WAF 고정**: 8 $* **Secrets Manager**: 0.4$
* **ALB**: 16.43 $* **CloudTrail**: 0$
* **CloudWatch 경보 1개**: 0.1 $* **SSM Session Manager**: 0$
* **ACM**: 0 $* **합계**: 24.93$

**결과: 나머지 서비스 총합 = 24.93 USD / 월**
